...
insert into Player (firstName, lastName, ssn, email, phoneNumber, netWorth, numDependents, frustrationLevel, tableId) values ('Laurette', 'Pyatt', '359-49-1321', 'lpyattk@photobucket.com', '408-277-5496', 3309321, 4, 4, '2');
...
insert into AdminTableBridge (tableId, adminId) values ('1', '29');
insert into AdminTableBridge (tableId, adminId) values ('2', '32');
insert into AdminTableBridge (tableId, adminId) values ('3', '30');
insert into AdminTableBridge (tableId, adminId) values ('4', '17');
insert into AdminTableBridge (tableId, adminId) values ('5', '43');
insert into AdminTableBridge (tableId, adminId) values ('6', '16');
insert into AdminTableBridge (tableId, adminId) values ('7', '19');
insert into AdminTableBridge (tableId, adminId) values ('8', '49');
insert into AdminTableBridge (tableId, adminId) values ('9', '1');
insert into AdminTableBridge (tableId, adminId) values ('10', '48');
